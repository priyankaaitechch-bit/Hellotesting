...
## ⚠️ CRITICAL: NO FONT NAMES IN NAMEPLATE TEXT

When writing nameplate descriptions, describe the visual style (e.g., "elegant serif", "bold black serif", "smaller dark gold serif") — but **NEVER include actual font names** like "Trajan", "Playfair Display", "Bebas Neue", "Impact" etc. as text inside the nameplate. AI image generators will render font names as literal visible text on the image.

❌ WRONG: `"RONALDO" larger bold black serif (Trajan / Playfair Display)`
✅ RIGHT: `"RONALDO" larger bold black elegant serif`

This rule applies to ALL templates below. Heading banners may mention font style descriptors but not font names either.
...
condensed bold sans-serif font. Decorative thin 
...
- LEFT NAMEPLATE: top line "[PLAYER 1 FIRST NAME]" in smaller dark 
  gold elegant serif; bottom line "[PLAYER 1 LAST NAME]" in larger 
  bold black elegant serif; small metallic gold heart icon on right.
- RIGHT NAMEPLATE: top line "[PLAYER 2 FIRST NAME]" in smaller dark 
  gold elegant serif; bottom line "[PLAYER 2 LAST NAME]" in larger 
  bold black elegant serif; small metallic gold heart icon on right.
...
gradient, rest in clean bright white. Heavy condensed bold sans-serif 
font. Decorative gold horizontal lines on both sides. Subtle inner glow.
...
- LEFT NAMEPLATE: "[PLAYER 1 FIRST NAME]" in smaller dark gold 
  elegant serif / "[PLAYER 1 LAST NAME]" in larger bold black 
  elegant serif + small gold heart icon on right.
- CENTER NAMEPLATE: "[PLAYER 2 FIRST NAME]" in smaller dark gold 
  elegant serif / "[PLAYER 2 LAST NAME]" in larger bold black 
  elegant serif + small gold heart icon on right.
- RIGHT NAMEPLATE: "[PLAYER 3 FIRST NAME]" in smaller dark gold 
  elegant serif / "[PLAYER 3 LAST NAME]" in larger bold black 
  elegant serif + small gold heart icon on right.
...
Heavy condensed bold sans-serif font. Decorative gold horizontal lines 
...
- Across the bottom of the quadrant: small cream nameplate strip 
  with gold border, text "[PLAYER 1 FULL NAME]" in bold elegant 
  serif, small gold heart icon.
...
- Bottom strip nameplate with "[PLAYER 2 FULL NAME]" in bold 
  elegant serif + small gold heart icon.
...
- Bottom strip nameplate with "[PLAYER 3 FULL NAME]" in bold 
  elegant serif + small gold heart icon.
...
- Bottom strip nameplate with "[PLAYER 4 FULL NAME]" in bold 
  elegant serif + small gold heart icon.
...
| User input | Template | Player count |
|---|---|---|
| `Football` | Template A (default 2 players) | 2 |
| `3 players Football` | Template B | 3 |
| `Football - Kane, Yamal, Dembele` | Template B | 3 |
| `4 players NBA` | Template C | 4 |
| `Football - Ronaldo, Messi` | Template A | 2 |
| `NBA - Jordan, LeBron, Kobe` | Template B | 3 |
| `F1 - Senna, Schumacher, Hamilton, Verstappen` | Template C | 4 |
| `Football - Pele, Maradona, Ronaldo, Messi` | Template C | 4 |

**FINAL CHECK:** Before outputting, count how many player description blocks are in your prompt. This number MUST match the player count. If you wrote 2 blocks but 3 were requested, your output is WRONG — redo it.
